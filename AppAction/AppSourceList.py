...
def AppSourceList(self):
    # 点击联系客服按钮
    self.driver.find_element("id","com.kachexiongdi.trucker:id/iv_toolbar_customer").click()
    # 点击取消按钮
    ...
    sleep(4)
    # 勾选常跑路线
    self.driver.find_element("id","com.kachexiongdi.trucker:id/rb_often_run_route").click()
    # 勾选车队单
    self.driver.find_element("id","com.kachexiongdi.trucker:id/rb_orientation").click()
    # 点击排序按钮
    self.driver.find_element("id","com.kachexiongdi.trucker:id/tv_sort").click()
    # 点击距我最近按钮
    self.driver.find_element("xpath","//*[@text='距我最近' and contains(@resource-id, "
                                      "'com.kachexiongdi.trucker:id/tv_item_title')]").click()
    sleep(1)
    # 再次点击排序按钮
    self.driver.find_element("id","com.kachexiongdi.trucker:id/tv_sort").click()
    # 点击价格最高按钮
    self.driver.find_element("xpath","//*[@text='价格最高' and contains(@resource-id, "
                                      "'com.kachexiongdi.trucker:id/tv_item_title')]").click()
    sleep(1)
    # 点击第一个货源，会进入货源详情页
